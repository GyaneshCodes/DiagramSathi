  ...
  return (
    <div ref={menuRef} className="relative">
      <button
        ...
        className="p-1.5 rounded-md text-neutral/30 hover:text-neutral/80 hover:bg-neutral/10 transition-colors cursor-pointer"
        aria-label="Actions"
      >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 top-full mt-1 z-50 min-w-[200px] bg-panel border border-border rounded-xl shadow-2xl overflow-hidden"
          >
